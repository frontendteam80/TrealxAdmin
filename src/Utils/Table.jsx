...
// // /* ---------- Pagination component styled like your screenshot ---------- */
...
// //   const priceKeys = new Set(["AmountWithUnit", "Price", "DisplayAmount", "Amount", "DisplayPrice", "DisplayPriceRange"]);
...
// //                   }}
// //                 >
// //                   <div style={{ display: "flex", alignItems: "center", gap: 8, justifyContent: isPrice ? "flex-end" : "flex-start" }}>
...
// //                             Cancel
// //                           </button>
// //                           <button onClick={() => applyFor(col.key)} style={{ padding: "7px 12px", borderRadius: 6, border: "none", background: "#2563eb", color: "#fff", cursor: "pointer", fontSize: 13 }}>
// //                             Apply
// //                           </button>
// //                         </div>
// //                       </div>
...
// //                     const isPrice = priceKeys.has(col.key) || (col.label && String(col.label).toLowerCase().includes("price"));
// //                     const align = isPrice ? "right" : "left";

// //                     let cellContent;
// //                     if (col.key === "serialNo" || col.key === "serial" || String(col.label || "").toLowerCase().includes("s.no")) {
...
// //                     return (
// //                       <td key={cIdx} className="tutils-td" style={{ textAlign: align, paddingLeft: 12, paddingRight: isPrice ? 16 : 12, verticalAlign: "middle", maxWidth: col.maxWidth || undefined, whiteSpace: col.wrap === false ? "nowrap" : "normal" }}>
// //                         {cellContent}
// //                       </td>
// //                     );
// //                   })}
...
//   // Lock body scroll if filter dropdown is open
//   useEffect(() => {
//     const prev = document.body.style.overflow;
//     document.body.style.overflow = openFilter ? "hidden" : prev || "auto";
//     return () => (document.body.style.overflow = prev || "auto");
...
//       const res = col.render(row[col.key], row, rIdx);
//       if (typeof res === "string" || typeof res === "number") {
//         if (priceKeys.has(col.key) || (col.label && String(col.label).toLowerCase().includes("price")))
...
//             {columns.map((col) => {
//               const isPrice =
//                 priceKeys.has(col.key) || (col.label && String(col.label).toLowerCase().includes("price"));
//               // Decide header alignment: right if price or numeric column detected
//               // You can enhance this by checking other numeric keys if needed here
//               const headerAlign = isPrice ? "right" : "left";
//               return (
//                 <th
//                   key={col.key}
//                   ref={(el) => (thRefs.current[col.key] = el)}
...
//                       alignItems: "center",
//                       gap: 8,
//                       justifyContent: headerAlign === "right" ? "flex-end" : "flex-start",
//                     }}
//                   >
//                     <span
//                       style={{
...
//                     const align = isNumeric(cellContent) ? "center" : "left";
...
//                           textAlign: align,
//                           paddingLeft: 12,
//                           paddingRight: isNumeric(cellContent) ? 24: 12,
