...
//   const amenities = [
//     { lat: data.latitude + 0.001, lng: data.longitude + 0.001, label: "School" },
//     { lat: data.latitude - 0.001, lng: data.longitude - 0.001, label: "Restaurant" },
//     { lat: data.latitude + 0.002, lng: data.longitude + 0.002, label: "Hospital" },
//   ];
...
//         {data.details.description} <a href="#">Read more</a>
//       </div>
